...
export const DEFAULT_FORMATTER = unpinned("biome") satisfies NewConfig["formatter"];
...
export const DEFAULT_PACKAGE_MANAGER = unpinned("pnpm") satisfies NewConfig["packageManager"];
...
export const DEFAULT_TEST_RUNNER = unpinned("node") satisfies NewConfig["testRunner"];
