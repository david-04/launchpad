export const ASSETS = {
    ".launchpad/Makefile.documentation": [
        ...
        "           exclude=package                             #     - don't bundle the given package (exclude= is repeatable)",
        ...
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
        "$(call lp.auto-import,                                # generate a file with \"import\" statements",
        "       src,                                           # directory containing the file to generate",
        "       rules.ts,                                      # the file to generate (auto-expands to src/rules.ts)",
        "       validation-rules/*.ts other-rules/*.ts         # wildcards relative to the base directory (auto-expands to",
        ")                                                     # src/validation-rules/*.ts and src/other-rules/*.ts)",
        "",
    ].join("\n"),
    ".launchpad/Makefile.footer": [
        ...
        "",
        "$(call lp.fn.declare-phony-targets, bundle, lp.bundle.error)",
        "",
        "lp.bundle.error :",
    ...
    ".launchpad/Makefile.header": [
        ...
        "",
        "LP_CFG_DTS_BUNDLER_ENUMS=\"disabled\" or \"dts-bundle-generator\"",
        "$(call lp.fn.config.validate-enum, LP_CFG_DTS_BUNDLER)",
        "",
        "LP_CFG_TEST_RUNNER_ENUMS=\"disabled\" or \"node\"",
        "$(call lp.fn.config.validate-enum, LP_CFG_TEST_RUNNER)",
        "",
        "LP_CFG_FORMATTER_ENUMS=\"disabled\", \"biome\", \"oxfmt\" or \"prettier\"",
        ...
        "__LP_TSC_TIMESTAMP_FILE                 =$(if $(LP_CFG_TSC_OUT_DIR),$(LP_CFG_TSC_OUT_DIR)/.timestamp.tsc,$(__LP_HOME_DIR)/.timestamp.tsc.tmp)",
        "",
        ...
        "__LP_TSC_DEFAULT_TARGETS                =$(__LP_TSC_TIMESTAMP_FILE)",
        ...
        "lp.tsc.overwrite-targets                =$(call lp.fn.assert.param-not-empty, lp.tsc.overwrite-targets, $(if $(value 1), $(1))) \\",
        ...
        "lp.tsc.overwrite-command                =$(call lp.fn.assert.param-not-empty, lp.tsc.overwrite-command, $(if $(value 1), $(1))) \\",
        ...
        "lp.tsc.get-default-command              =$(if $(value 1), echo $(1) && )$(strip $(__LP_TSC_DEFAULT_COMMAND))",
        "lp.tsc.get-effective-command            =$(if $(strip $(__LP_TSC_EFFECTIVE_COMMAND)),$(strip $(__LP_TSC_EFFECTIVE_COMMAND)) &&) \\",
        "                                         touch \"$(__LP_TSC_TIMESTAMP_FILE)\"",
        "lp.tsc.get-command-with-hooks           =$(call lp.fn.get-command, tsc, $(if $(value 1), $(1)))",
        "",
        ...
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
        "__LP_TEST_ROOT_DIRECTORIES             =$(LP_CFG_TSC_OUT_DIR)",
        "__LP_TEST_SUBDIRECTORY                 =",
        "__LP_TEST_FILE_EXTENSION               =.test.js",
        "__LP_TEST_TIMESTAMP_FILE               =$(if $(LP_CFG_TSC_OUT_DIR),$(LP_CFG_TSC_OUT_DIR)/.timestamp.test,$(__LP_HOME_DIR)/.timestamp.test.tmp)",
        "",
        "__LP_TEST_ENABLED                      =$(if $(LP_CFG_TEST_RUNNER),true)",
        "__LP_TEST_DEFAULT_TARGETS              =$(__LP_TEST_TIMESTAMP_FILE)",
        "__LP_TEST_EFFECTIVE_TARGETS            =$(__LP_TEST_DEFAULT_TARGETS)",
        "__LP_TEST_DEFAULT_PREREQUISITES        =$(call lp.tsc.get-targets) $(__LP_MAKEFILES_AND_SETTINGS) $(__LP_TSC_TIMESTAMP_FILE)",
        "__LP_TEST_EFFECTIVE_PREREQUISITES      =$(__LP_TEST_DEFAULT_PREREQUISITES)",
        "__LP_TEST_DEFAULT_BEFORE_HOOKS         =",
        "__LP_TEST_EFFECTIVE_BEFORE_HOOKS       =$(__LP_TEST_DEFAULT_BEFORE_HOOKS)",
        "__LP_TEST_DEFAULT_AFTER_HOOKS          =",
        "__LP_TEST_EFFECTIVE_AFTER_HOOKS        =$(__LP_TEST_DEFAULT_AFTER_HOOKS)",
        "",
        "__LP_TEST_DEFAULT_COMMAND_             =",
        "__LP_TEST_DEFAULT_COMMAND_node         =. .launchpad/test $(foreach ROOT_DIRECTORY, $(__LP_TEST_ROOT_DIRECTORIES), '$(ROOT_DIRECTORY)/**$(if $(__LP_TEST_SUBDIRECTORY),/$(strip $(__LP_TEST_SUBDIRECTORY)))/*$(strip $(__LP_TEST_FILE_EXTENSION))')",
        "__LP_TEST_DEFAULT_COMMAND              =$(__LP_TEST_DEFAULT_COMMAND_$(LP_CFG_TEST_RUNNER))",
        "__LP_TEST_EFFECTIVE_COMMAND            =$(__LP_TEST_DEFAULT_COMMAND)",
        "",
        "lp.test.disable                        =$(call lp.fn.var.erase, __LP_TEST_ENABLED)",
        "",
        "lp.test.add-extra-prerequisites        =$(call lp.fn.var.append, __LP_TEST_EFFECTIVE_PREREQUISITES, $(1))",
        "lp.test.overwrite-prerequisites        =$(call lp.fn.var.assign, __LP_TEST_EFFECTIVE_PREREQUISITES, $(1))",
        "lp.test.add-before-hook                =$(call lp.fn.var.append-with-separator, __LP_TEST_EFFECTIVE_BEFORE_HOOKS, &&, $(1))",
        "lp.test.overwrite-before-hooks         =$(call lp.fn.var.assign, __LP_TEST_EFFECTIVE_BEFORE_HOOKS, $(1))",
        "lp.test.add-after-hook                 =$(call lp.fn.var.append-with-separator, __LP_TEST_EFFECTIVE_AFTER_HOOKS, &&, $(1))",
        "lp.test.overwrite-after-hooks          =$(call lp.fn.var.assign, __LP_TEST_EFFECTIVE_AFTER_HOOKS, $(1))",
        "lp.test.overwrite-command              =$(call lp.fn.assert.param-not-empty, lp.test.overwrite-command, $(1)) \\",
        "                                        $(call lp.fn.var.assign, __LP_TEST_EFFECTIVE_COMMAND, $(1))",
        "",
        "lp.test.set-root-directories           =$(call lp.fn.assert.param-not-empty, set-root-directories, $(1)) \\",
        "                                        $(call lp.fn.var.assign, __LP_TEST_ROOT_DIRECTORIES, $(1))",
        "lp.test.set-subdirectory               =$(call lp.fn.var.assign, __LP_TEST_SUBDIRECTORY, $(if $(value 1), $(1)))",
        "lp.test.set-file-extension             =$(call lp.fn.assert.param-not-empty, set-file-extension, $(1)) \\",
        "                                        $(call lp.fn.var.assign, __LP_TEST_FILE_EXTENSION, $(1))",
        "",
        "lp.test.get-phony-targets              =test",
        "lp.test.get-name                       =Test",
        "lp.test.get-description                =run unit tests",
        "lp.test.is-enabled                     =$(strip $(__LP_TEST_ENABLED))",
        "lp.test.get-default-prerequisites      =$(__LP_TEST_DEFAULT_PREREQUISITES)",
        "lp.test.get-prerequisites              =$(__LP_TEST_EFFECTIVE_PREREQUISITES)",
        "lp.test.get-default-targets            =$(__LP_TEST_DEFAULT_TARGETS)",
        "lp.test.get-targets                    =$(__LP_TEST_EFFECTIVE_TARGETS)",
        "lp.test.get-default-before-hook        =$(strip $(__LP_TEST_DEFAULT_BEFORE_HOOKS))",
        "lp.test.get-before-hooks               =$(strip $(__LP_TEST_EFFECTIVE_BEFORE_HOOKS))",
        "lp.test.get-default-after-hook         =$(strip $(__LP_TEST_DEFAULT_AFTER_HOOKS))",
        "lp.test.get-after-hooks                =$(strip $(__LP_TEST_EFFECTIVE_AFTER_HOOKS))",
        "lp.test.get-default-command            =$(if $(value 1), echo $(1) && )$(strip $(__LP_TEST_DEFAULT_COMMAND))",
        "lp.test.get-effective-command          =$(strip $(__LP_TEST_EFFECTIVE_COMMAND))",
        "lp.test.get-effective-command          =$(if $(strip $(__LP_TEST_EFFECTIVE_COMMAND)),$(strip $(__LP_TEST_EFFECTIVE_COMMAND)) && touch \"$(__LP_TEST_TIMESTAMP_FILE)\")",
        "lp.test.get-command-with-hooks         =$(call lp.fn.get-command, test, $(if $(value 1), $(1)))",
        "",
        "LP_PREREQUISITE_TEST                   =$$(call lp.test.get-targets)",
        "",
        "#-----------------------------------------------------------------------------------------------------------------------",
        "#",
        "#   ########  ##     ## ##    ## ########  ##       ########",
        ...
        "",
        "__LP_BUNDLE_ALLOWED_OPTIONS             =minify web cli sourcemap inline-sources esm cjs dts shebang exclude=%",
        "",
        ...
        "                                         $(call lp.fn.assert.param-not-empty, lp.bundle.add, $(if $(value 1), $(1))) \\",
        "                                         $(call lp.fn.assert.param-not-empty, lp.bundle.add, $(if $(value 2), $(2))) \\",
        "                                         $(call lp.bundle.validate-options,$(strip $(if $(value 3), $(3)))) \\",
        "                                         $(call lp.bundle.create-js-rule,$(strip $(1)),$(strip $(2)),$(strip $(if $(value 3), $(3))),$(strip $(if $(value 4), $(4)))) \\",
        "                                         $(if $(filter dts,$(strip $(if $(value 3), $(3)))), \\",
        "                                              $(if $(LP_CFG_DTS_BUNDLER),,$(error lp.bundle.add can't be called with the \"dts\" option when dts-bundling is disabled)) \\",
        "                                              $(call lp.bundle.create-dts-rule,$(strip $(1)),$(call lp.bundle.js-extension-to-dts,$(strip $(2))),$(strip $(if $(value 3), $(3))),$(strip $(if $(value 5), $(5)))) \\",
        "                                          )",
        "",
        ...
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
        "__LP_FORMAT_EXTENSIONS_biome            =css gql graphql htm html js json jsonc json5 jsx                        ts tsx",
        "__LP_FORMAT_EXTENSIONS_oxfmt            =css gql graphql htm html js json jsonc json5 jsx less md      scss toml ts tsx yaml yml",
        "__LP_FORMAT_EXTENSIONS_prettier         =css             htm html js json             jsx less md sass           ts tsx",
        "__LP_FORMAT_EXTENSIONS                  =$(__LP_FORMAT_EXTENSIONS_$(LP_CFG_FORMATTER))",
        "",
        "__LP_FORMAT_ENABLED                     =$(if $(LP_CFG_FORMATTER),true)",
        "__LP_FORMAT_DEFAULT_PREREQUISITES       =$(call lp.tsc.get-targets) $(__LP_MAKEFILES_AND_SETTINGS)",
        "__LP_FORMAT_EFFECTIVE_PREREQUISITES     =$(call lp.test.get-default-prerequisites)",
        "",
        "",
        "",
        ...
        "__LP_FORMAT_DEFAULT_COMMAND_oxfmt       =oxfmt -c oxfmt.config.mjs --write $(patsubst %, '%', $(call lp.format.get-paths))",
        ...
        "lp.format.overwrite-command             =$(call lp.fn.assert.param-not-empty, lp.format.overwrite-command, $(if $(value 1), $(1))) \\",
        ...
        "lp.format.get-default-command           =$(if $(value 1), echo $(1) && )$(strip $(__LP_FORMAT_DEFAULT_COMMAND))",
        "lp.format.get-effective-command         =$(strip $(__LP_FORMAT_EFFECTIVE_COMMAND))",
        "lp.format.get-command-with-hooks        =$(call lp.fn.get-command, format, $(if $(value 1), $(1)))",
        ...
        "lp.uplift.overwrite-command             =$(call lp.fn.assert.param-not-empty, lp.uplift.overwrite-command, $(if $(value 1), $(1))) \\",
        ...
        "lp.uplift.get-default-command           =$(if $(value 1), echo $(1) && )$(strip $(__LP_UPLIFT_DEFAULT_COMMAND))",
        "lp.uplift.get-effective-command         =$(strip $(__LP_UPLIFT_EFFECTIVE_COMMAND))",
        "lp.uplift.get-command-with-hooks        =$(call lp.fn.get-command, uplift, $(if $(value 1), $(1)))",
        "",
        "",
        "#-----------------------------------------------------------------------------------------------------------------------",
        "#",
        ...
        "lp.clean.overwrite-command              =$(call lp.fn.assert.param-not-empty, lp.clean.overwrite-command, $(if $(value 1), $(1))) \\",
        "                                         $(call lp.fn.var.assign, __LP_CLEAN_EFFECTIVE_COMMAND, $(1))",
        "",
        "lp.clean.npm-packages                   =$(call lp.clean.files, node_modules)",
        "lp.clean.tsc-output                     =$(call lp.clean.files, $(if $(strip $(LP_CFG_TSC_OUT_DIR)), $(LP_CFG_TSC_OUT_DIR), $(__LP_TSC_BUILDINFO) $(__LP_TSC_TIMESTAMP_FILE)))",
        ...
        "lp.clean.get-default-command            =$(if $(value 1), echo $(1) && )$(strip $(__LP_CLEAN_DEFAULT_COMMAND))",
        "lp.clean.get-effective-command          =$(strip $(__LP_CLEAN_EFFECTIVE_COMMAND))",
        "lp.clean.get-command-with-hooks         =$(call lp.fn.get-command, clean, $(if $(value 1), $(1)))",
        ...
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
        "lp.run.js                               =node --enable-source-maps $(1)",
        ...
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
        "__LP_AUTO_IMPORT_RULES               =",
        "",
        "lp.auto-import.get-base-directory    =$(strip $(patsubst ./%,%,$(if $(patsubst %/,%,$(strip $(1))),$(patsubst %/,%,$(strip $(1)))/)))",
        "lp.auto-import.normalize-extension   =$(strip $(if $(patsubst esm,,$(LP_CFG_MODULE_SYSTEM)),$(1),$(patsubst %.ts,%.js, $(patsubst %.tsx,%.js,$(1)))))",
        "lp.auto-import.get-import-statement  =import \"./$(call lp.auto-import.normalize-extension,$(patsubst $1%,%,$(2)))\";",
        "lp.auto-import.get-import-statements =$(foreach FILE,$(2),$(call lp.auto-import.get-import-statement,$(strip $(1)),$(FILE)))",
        "",
        "define lp.auto-import.define-rule",
        "$(1)$(2) : $$(sort $$(wildcard $$(foreach GLOB,$(3),$(1)$$(GLOB))))",
        "\t$$(info Updating $(1)$(2)...)",
        "\t$$(file > $(1)$(2),$$(subst ; import,;$$(__LP_LINE_BREAK)import,$$(call lp.auto-import.get-import-statements, \\",
        "        $(strip $(1)),\\",
        "        $$(sort $$(wildcard $$(foreach GLOB,$(3),$(1)$$(GLOB)))) \\",
        "    )))",
        "$(__LP_LINE_BREAK)",
        "endef",
        "",
        "lp.auto-import =$(call lp.fn.assert.param-not-empty, lp.auto-import, $(if $(value 1), $(1))) \\",
        "                $(call lp.fn.assert.param-not-empty, lp.auto-import, $(if $(value 2), $(2))) \\",
        "                $(call lp.fn.assert.param-not-empty, lp.auto-import, $(if $(value 3), $(3))) \\",
        "                $(call lp.fn.var.append, __LP_AUTO_IMPORT_RULES, \\",
        "                    $$(call lp.auto-import.define-rule,$(strip \\",
        "                        $(call lp.auto-import.get-base-directory,$(1)) \\",
        "                    ),$(strip \\",
        "                        $(patsubst ./%,%,$(2)) \\",
        "                    ),$(strip \\",
        "                        $(3) \\",
        "                    )) \\",
        "                ) \\",
        "                $(call lp.tsc.add-extra-prerequisites, $(call lp.auto-import.get-base-directory, $(1))$(strip $(2)))",
        "",
    ].join("\n"),
    ...
    ".launchpad/test-reporter-node-tap.awk": [
        "#-----------------------------------------------------------------------------------------------------------------------",
        "# Initialization",
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
    ...
    "biome.json": [
        "{ \"$schema\": \"https://biomejs.dev/schemas/2.4.15/schema.json\", \"extends\": [\"./.launchpad/biome.default.json\"] }",
        "",
    ].join("\n"),
    "oxfmt.config.mjs": [
        "import defaultConfig from \"./.launchpad/oxfmt.default.json\" with { type: \"json\" };",
        "",
