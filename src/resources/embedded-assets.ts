export const ASSETS = {
    ...
    ".launchpad/Makefile.header": [
        ...
        "",
        "LP_SETTINGS_FORMATTER_ENUMS=\"disabled\" or \"prettier\"",
        ...
        "",
        "LP_SETTINGS_INSTALLATION_MODE_ENUMS=\"local\", \"temp\", \"global-auto-update\" or \"global\"",
        "$(call lp.fn.config.validate-enum, LP_SETTINGS_INSTALLATION_MODE)",
        "ifeq \"$(LP_SETTINGS_PACKAGE_MANAGER)-$(LP_SETTINGS_INSTALLATION_MODE)\" \"yarn-global-auto-update\"",
        "    $(call lp.fn.config.fail, LP_SETTINGS_PACKAGE_MANAGER=yarn can't be combined with LP_SETTINGS_INSTALLATION_MODE=global-auto-update)",
        "endif",
        "",
        ...
        "lp.bundle.enabled-dts                   =$(call lp.fn.var.assign, __LP_BUNDLER_DTS_BUNDLER, $(if $(LP_SETTINGS_DTS_BUNDLER), $(LP_SETTINGS_DTS_BUNDLER), $(__LP_DEFAULT_DTS_BUNDLER)))",
    ...
    ".launchpad/settings.cfg": [
        "#-----------------------------------------------------------------------------------------------------------------------",
        "# This file is overwritten when performing a launchpad uplift or init",
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
        "LP_SETTINGS_VERSION           = 0.0.0",
        "LP_SETTINGS_PROJECT_NAME      = launchpad",
        "",
        "LP_SETTINGS_ARTIFACT          = app                   # app, lib",
        "LP_SETTINGS_RUNTIME           = node                  # node, web",
        "LP_SETTINGS_MODULE_SYSTEM     = esm                   # cjs, esm",
        "",
        "LP_SETTINGS_BUNDLER           = esbuild               # disabled, esbuild",
        "LP_SETTINGS_DTS_BUNDLER       = dts-bundle-generator  # disabled, dts-bundle-generator",
        "LP_SETTINGS_FORMATTER         = prettier              # disabled, prettier",
        "LP_SETTINGS_TAB_SIZE          = 4",
        "LP_SETTINGS_PACKAGE_MANAGER   = yarn                  # npm, pnpm, yarn",
        "LP_SETTINGS_INSTALLATION_MODE = global                # global-auto-update, global, local, temp",
        "",
        "LP_SETTINGS_SRC_DIR           = src                   # mandatory",
        "LP_SETTINGS_WEB_APP_DIR       =",
        "LP_SETTINGS_TSC_OUT_DIR       = build                 # mandatory",
        "LP_SETTINGS_BUNDLER_OUT_DIR   = dist",
        "",
    ].join("\n"),
