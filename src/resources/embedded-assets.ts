export const ASSETS = {
    ".launchpad/Makefile.documentation": [
        ...
        "",
        "$(call lp.bundle.add-before-hook         , pwd && ls ) # append commands to run before bundling",
        "$(call lp.bundle.overwrite-before-hooks  , pwd && ls ) # overwrite any previously defined before-hook commands",
        "$(call lp.bundle.add-after-hook          , pwd && ls ) # append commands to run after bundling",
