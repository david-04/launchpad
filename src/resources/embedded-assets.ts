export const ASSETS = {
    ...
    ".launchpad/Makefile.header": [
        ...
        "$(call lp.format.remove-files-from, __LP_FORMAT_DEFAULT_FILES, $(call lp.fn.wildcard, $(LP_CFG_TSC_OUT_DIR) , *))",
        "",
        ...
        "",
        "__LP_RUN_JS                             =node",
        "__LP_RUN_TS                             =$(call lp.fn.if-equal, $(LP_CFG_MODULE_SYSTEM), esm, ts-node-esm, ts-node)",
        "",
    ...
    "resources/templates/index.css": ["html {", "    font-family: sans-serif;", "}", ""].join("\n"),
