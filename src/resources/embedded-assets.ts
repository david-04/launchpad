export const ASSETS = {
    ".launchpad/Makefile.documentation": [
        ...
        "",
        "$(lp.help.set-diagnostics-keywords, help info dump config       ) # set aliases for diagnostics targets like tsc.help",
        "",
        "#-----------------------------------------------------------------------------------------------------------------------",
        "# Compile",
        "#-----------------------------------------------------------------------------------------------------------------------",
    ...
    ".launchpad/Makefile.footer": [
        ...
        "        $(foreach shortcut, $(call lp.diagnostics.get-phony-targets), \\",
    ...
    ".launchpad/Makefile.header": [
        ...
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
        "__LP_DIAGNOSTICS_KEYWORDS=help info debug",
        "",
        "lp.diagnostics.get-phony-targets =$(__LP_DIAGNOSTICS_KEYWORDS)",
        "lp.help.set-diagnostics-keywords=$(call lp.fn.var.assign, __LP_DIAGNOSTICS_KEYWORDS, $(1))",
        "",
        ...
        ".PHONY: lp.$(1).$(2) lp.$(2).$(1) $(if $(call lp.help.is-enabled), $(1).$(2) $(2).$(1))",
        "lp.$(1).$(2) lp.$(2).$(1) $(if $(call lp.help.is-enabled), $(1).$(2) $(2).$(1)) : ;",
        "\t$$(call lp.fn.print-diagnostics, $(1))",
        "endef",
        "",
        "$(call lp.help.add-target, <target>.help, ...... show diangostic information (aliases: $(sort $(call lp.diagnostics.get-phony-targets))))",
        "",
        "#-----------------------------------------------------------------------------------------------------------------------",
        "#",
        "#     ######   #######  ##     ## ########  #### ##       ########",
        ...
        "",
        "__LP_BUNDLE_ALLOWED_OPTIONS             =minify web cli sourcemap inline-sources esm cjs dts",
        "",
        ...
        "lp.bundle.get-js-command                =$(call lp.bundle.get-js-command-$(LP_SETTINGS_BUNDLER),$(1),$(2),$(3))",
        "",
        "# $1=src, $2=target, $3=options",
        ...
        "lp.bundle.get-dts-command               =$(call lp.bundle.get-dts-command-$(LP_SETTINGS_DTS_BUNDLER),$(1),$(2),$(3))",
        "",
        ...
        "lp.bundle.add                           =$(if $(LP_SETTINGS_BUNDLER),,$(error lp.bundle.add can't be called when bundling is disabled)) \\",
        ...
        "                                              $(if $(LP_SETTINGS_DTS_BUNDLER),,$(error lp.bundle.add can't be called with the \"dts\" option when dts-bundling is disabled)) \\",
