export const ASSETS = {
    ...
    ".launchpad/Makefile.footer": [
        ...
        "#-----------------------------------------------------------------------------------------------------------------------",
        "",
        "ifneq \"$(call lp.diagnostics.is-enabled)\" \"\"",
        "$(call lp.help.add-target, <target>.help, ...... show diagnostic information (aliases: $(sort $(call lp.diagnostics.get-target-names))))",
        "endif",
        "",
    ...
    ".launchpad/Makefile.header": [
        ...
        "                            $(call lp.help.add-builtin-target, uplift, uplift .............$(__LP_EXTRA_DOTS))",
        "",
